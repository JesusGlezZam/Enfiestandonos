...
import { FilteredItemList } from './Detail/ServiceIcons/FilteredItemList';
import { GaleryFirst } from './Detail/GaleryFirst'
...
export const DetalleLugar = () => {
  ...
  return (
    <div className='master-container contents'>
      ...
      <GaleryFirst itemType={itemType} name={formattedName} />
